...
class P2PoolHelpBox(HelpBoxBase):
    help_msgs = {
        "Wallet Address:": [
            "Your nevocoin wallet address for receiving mining reqards",
            "",
        ...
        "Disable Cache": [
            "Disable n2pool.cache (not recommended)",
        ],
        "Additional P2Pool Options:": [
            "Additional options to pass to n2pool commandline",
            "",
            "Note: Advanced - Only add options if you know what you are doing",
            "      See ouput of 'n2pool --help' for available options",
        ],
        "Next": [
...
class MoneroHelpBox(HelpBoxBase):
    help_msgs = {
        ...
        "Monero Version:": [
            ...
            "",
            "Note: Must be v0.17.3.0 or later for n2pool support",
        ...
        "Expose RPC Port": [
            ...
            "(wallets for example) can connect. Port 44233 (ZMQ-pub) will also be exposed.",
            "Note: You may choose to open this port in your hosts firewall and/or",
...
class ConfigApp(npyscreen.NPSAppManaged):
    ...
    def onStart(self):
        self.p2pool_form = self.addForm(
            "MAIN",
            P2PoolConfigForm,
            name="N2Pool for docker-compose: P2Pool Configuration",
            minimum_lines=35,
            minimum_columns=80,
        )
        self.monero_form = self.addForm(
            "MONERO",
            MoneroConfigForm,
            name="N2Pool for docker-compose: Nevocoin Configuration",
            minimum_lines=35,
            minimum_columns=80,
        )
        self.xmrig_form = self.addForm(
            "XMRIG",
            XMRigConfigForm,
            name="N2Pool for docker-compose: XMRig Configuration",
            minimum_lines=35,
            minimum_columns=80,
        )
