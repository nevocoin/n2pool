...
{
	fprintf(stderr, "N2Pool can't continue execution: panic at %s\n", message);
...
int add_portmapping(int external_port, int internal_port)
{
	...
	result = UPNP_AddPortMapping(urls.controlURL, data.first.servicetype, eport, iport, local_addr, "N2Pool", "TCP", nullptr, nullptr);
