...
constexpr uint64_t valid_prefixes[] = { 0x2f01, 53, 24 };

constexpr std::array<int, 9> block_sizes{ 0, 2, 3, 5, 6, 7, 9, 10, 11 };
constexpr int num_full_blocks = n2pool::Wallet::ADDRESS_LENGTH / block_sizes.back();
constexpr int last_block_size = n2pool::Wallet::ADDRESS_LENGTH % block_sizes.back();
