...
ConsoleCommands::ConsoleCommands(n2pool* pool)
...
typedef void (cmdfunc)(n2pool *pool, const char *args);
...
static cmd cmds[] = {
	...
	{ STRCONST("status"), "", "display n2pool status", do_status },
...
#endif
	{ STRCONST("exit"), "", "terminate n2pool", do_exit },
	{ STRCONST("version"), "", "show n2pool version", do_version },
	{ STRCNULL, NULL, NULL, NULL }
};

static void do_help(n2pool * /* m_pool */, const char * /* args */)
{
...
static void do_status(n2pool *m_pool, const char * /* args */)
{
...
static void do_loglevel(n2pool * /* m_pool */, const char *args)
{
...
static void do_addpeers(n2pool *m_pool, const char *args)
{
...
// cppcheck-suppress constParameterCallback
static void do_droppeers(n2pool *m_pool, const char * /* args */)
{
	if (m_pool->p2p_server()) {
...
// cppcheck-suppress constParameterCallback
static void do_showpeers(n2pool* m_pool, const char* /* args */)
{
	if (m_pool->p2p_server()) {
...
// cppcheck-suppress constParameterCallback
static void do_showworkers(n2pool* m_pool, const char* /* args */)
{
	if (m_pool->stratum_server()) {
...
// cppcheck-suppress constParameterCallback
static void do_showbans(n2pool* m_pool, const char* /* args */)
{
	if (m_pool->stratum_server()) {
...
// cppcheck-suppress constParameterCallback
static void do_showhosts(n2pool* m_pool, const char* /* args */)
{
	m_pool->print_hosts();
}

// cppcheck-suppress constParameterCallback
static void do_nexthost(n2pool* m_pool, const char* /* args */)
{
	m_pool->reconnect_to_host();
}

// cppcheck-suppress constParameterCallback
static void do_outpeers(n2pool* m_pool, const char* args)
{
	if (m_pool->p2p_server()) {
...
// cppcheck-suppress constParameterCallback
static void do_inpeers(n2pool* m_pool, const char* args)
{
	if (m_pool->p2p_server()) {
...
#ifdef WITH_RANDOMX
static void do_start_mining(n2pool* m_pool, const char* args)
{
...
static void do_stop_mining(n2pool* m_pool, const char* /*args*/)
{
	m_pool->stop_mining();
}
#endif

static void do_exit(n2pool *m_pool, const char * /* args */)
{
...
// cppcheck-suppress constParameterCallback
static void do_version(n2pool* m_pool, const char* /* args */)
{
